...
class rb_gb:
    def __init__(self):
        self._train_years = [2003, 2004, 2005, 2006, 2007, 2008, 2009, 1010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019]
        self._test_years = [2021, 2022]
        ...
        self._rb_test = rb_data.loc[rb_data['season'].isin[self.__train_years]]
        self._rb_train = rb_data.loc[rb_data['season'].isin[self.__test_years]]
        ...
        self._features = [
            ...
            'shuttle', 'next_season', 'next_season_future', 'fantasy_points_future', 'fantasy_points_ppr_future', 
            'fantasy_points_half_ppr_future', 'games_future', 'team_future', 'future_ppr/game', 'future_half_ppr/game', 
            'ppr/game', 'half_ppr/game', 'receiving_epa_team_tes', 'rushing_epa_team_qbs', 'dakota_team_qbs', 
            'passing_epa_team_qbs', 'receiving_epa_team_wrs', 'receiving_epa_team_rbs', 'rushing_epa_team_rbs'
            ]
